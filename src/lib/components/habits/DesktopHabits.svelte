...
<div class="space-y-8 pb-12 relative">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        >
            <div class="flex items-center gap-2 mb-1">
                ...
                <span class="text-sm font-medium text-primary">Best Streak</span
                >
            </div>
            <p class="text-2xl font-bold text-white">{insights.maxStreak}</p>
        ...
        {#if insights.atRisk > 0}
            ...
            >
                ...
                <p class="text-2xl font-bold text-white">{insights.atRisk}</p>
                <p class="text-xs text-muted mt-1">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {#each enhancedHabits as habit (habit.id)}
            <div
                class="card group hover:border-primary/50 transition-all relative overflow-hidden text-left {habit.status ===
                'at-risk'
            ...
            >
                ...
                >
                    ...
                    >
                        <h3
                            class="font-bold text-lg text-[var(--color-text)] group-hover:text-primary transition-colors mb-2"
                        >
                            {habit.name}
                        </h3>
                    ...
                    <div class="flex gap-2 items-center">
                        ...
                        >
                            {#if habit.isCompleted}<Check size={18} />{/if}
                        </button>
                    </div>
                </div>
